...
#   - staging-vpc            (grandfathered from before routebox-<env>-<resource> convention)
#   - staging-subnet-private-a  (same)
...
# ------------------------------------------------------------------
# ECS cluster — disabled until a valid ACM certificate exists for staging.
# ------------------------------------------------------------------
